...
void writeResults ( ) {
  ...
  FILE* stream = fopen("timing/timings_search_8.dat", "a+");
  fprintf(stream, "8,%f\n", total_time);
  fclose(stream);
}
...
int main( int argc, char* argv[]){
  ...
  //read return flag
  read_from_mx("__quark_mx_8/return_flag_8.mx", &returnFlag_csr_values, &returnFlag_JA, &returnFlag_IA, &returnFlag_nnz, &returnFlag_rows, &returnFlag_columns);

  //read line status
  read_from_mx("__quark_mx_8/line_status_8.mx", &lineStatus_csr_values, &lineStatus_JA, &lineStatus_IA, &lineStatus_nnz, &lineStatus_rows, &lineStatus_columns);

  //read quantity
  read_from_mx("__quark_mx_8/quantity_8.mx", &quantity_csr_values, &quantity_JA, &quantity_IA, &quantity_nnz, &quantity_rows, &quantity_columns);
  ...
  //read shipdate gt
  read_from_mx("__quark_mx_8/shipdate_gt_8.mx", &shipdate_gt_csr_values, &shipdate_gt_JA, &shipdate_gt_IA, &shipdate_gt_nnz, &shipdate_gt_rows, &shipdate_gt_columns);
  ...
  //read shipdate lt
  read_from_mx("__quark_mx_8/shipdate_lt_8.mx", &shipdate_lt_csr_values, &shipdate_lt_JA, &shipdate_lt_IA, &shipdate_lt_nnz, &shipdate_lt_rows, &shipdate_lt_columns);
